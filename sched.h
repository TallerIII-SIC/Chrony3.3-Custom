/*Esta es una modificación del archivo 'sched.h' original presente en Chrony 3.3 
...
extern void SCH_GetLastEventTime(struct timespec *cooked, double *err, struct timespec *raw, struct timespec *raw_raw);
